    ...
    <section className="pt-28 md:pt-36 pb-12 md:pb-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
        <div>
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-6">A fresh look for the kitchen you love. Tell Alex where your project is, and we’ll help with measurements, tile choices, and a personal installation quote.</p>
